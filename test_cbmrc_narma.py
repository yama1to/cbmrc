...
### 共通設定
from main_cbmrc_narma import Config
config = Config()
common.config  = config
common.prefix  = "data%s_cbmrc_narma" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_cbmrc_narma" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python3 main_cbmrc_narma.py " # 実行されるプログラム
common.columns =['seed','id','NN','Nh','alpha_i','alpha_r','alpha_b','alpha_s','beta_i','beta_r','beta_b','Temp','lambda0','delay','cnt_overflow',"RMSE",'NRMSE',"NMSE"]
common.parallel= 128
common.setup()
