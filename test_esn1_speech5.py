...
### 共通設定
from main_esn1_speech5 import Config
config = Config()
common.config  = config
common.prefix  = "data%s_esn1_speech5" % common.string_now() # 実験名（ファイルの接頭辞）
common.dir_path= "data/data%s_esn1_speech5" % common.string_now() # 実験データを出力するディレクトリのパス
common.exe     = "python3 main_esn1_speech5.py " # 実行されるプログラム
